...
export default async function FinancialPlanDetailPage({
  params,
}: Props) {
  ...
  const selectedResult = await analyzeScenario(
    selectedModel,
  );
      ...
      <Card className="p-6">
        ...
        <div className="space-y-2">
          ...
          <p>
            ...
            {selectedModel.contract_months} months
          </p>
        </div>
      </Card>
        ...
        <ul className="list-disc pl-5 space-y-2">
          ...
          {impactResult.term_commitment_delta !== null && (
            <li>
              ...
              {Math.abs(
                impactResult.term_commitment_delta,
              ).toLocaleString()}
            </li>
          )}
        </ul>
